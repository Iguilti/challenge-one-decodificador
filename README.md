...
Bem-vindo ao projeto de criptografia de texto! Neste projeto, é possivel fazer a criptografar/descriptografar textos de acordo com algumas regras específicas.
...
Usar apenas letras minúsculas e sem acentuação.
...
1. Acesse a página da aplicação [clicando aqui](https://iguilti.github.io/challenge-one-decodificador/).
